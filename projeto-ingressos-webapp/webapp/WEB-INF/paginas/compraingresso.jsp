	...
	<div class="container"> <!-- essa classe vai centralizar o contéudo  da página -->
		...
		<form:form action="${salva}" modelAttribute="compra" cssClass="mb-2">
			...
			<div class="form-group">		
				...
				<input type="date" class="form-control" name="data_venda" value="${cliente.data_venda}" />
			...
			<div class="form-group">	
				...
				<textarea rows="3" name="observacao" maxlwcols=""></textarea>
		...
		<table class="table table-striped">
			...
			<tbody>	
				<c:forEach var="evento" items="${compras}">
					<tr>
						<td>${compra.id}</td>
						<td>${compra.valor}</td>
